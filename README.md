...
| **Hiệu ứng nằm ở đâu** | **Chưa nói được.** Nhóm đồ thị 4 cạnh (+9,61 pp, n=230) là nhóm duy nhất vượt hiệu chỉnh, nhưng cũng là nhóm đông nhất; các nhóm số cạnh không khác nhau phân định được (kiểm định hoán vị p=0,166; 4 cạnh trừ phần còn lại +8,18 [-0,09 ; +16,59], p=0,0445-0,0565 qua năm seed). Bỏ `arrowhead`, họ duy nhất có thể mang nhãn sai, con số tiêu đề là +7,24 [+3,04 ; +11,28]. Chạy `scripts/analyze_by_family.py` |
